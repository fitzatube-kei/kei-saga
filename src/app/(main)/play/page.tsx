...
// 로그아웃 상태 및 신규 가입 회원은 고조선만 접근 가능
const FREE_ERAS = new Set(['gojoseon']);
    ...
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {eras.map((era) => {
            const hasContent = UNLOCKED_ERAS.has(era.id);
            const canAccess = isLoggedIn ? hasContent : FREE_ERAS.has(era.id);
